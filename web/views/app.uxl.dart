...
List<View> TodoMVCTemplate({View parent, list}) { //6#
  ...
  List<View> _c0T({View parent, View beforeChild}) { //7#
    ...
    //8# <TextView class="h1" text="todos">
    ...
    //18# <View tag="ul" id="todo-list" layout...>
    ...
    for (var t in app.todos) {
      ...
      List<View> _ca0T({View parent, View beforeChild}) { //20#
        List<View> _rvb = new List(); View _this_;

        //20# <View tag="li" class="${t.completed...>
        ...
        //23# <CheckBox class="toggle" value="${t....>
        ...
        //24# <TextView class="title" text="${t.ti...>
        ...
        //25# <Button class="destroy" on.click="de...>
        ...
        //28# <TextBox class="edit" profile="width...>
    ...
    //34# <View tag="footer" id="footer">
    final _va0_2 = _this_ = new View.tag('footer')
      ..id = '''footer''';
    _va0.addChild(_va0_2);

    //35# <TextView id="todo-count" html="<str...>
    ...
    //36# <Button id="clear-completed" text="C...>
